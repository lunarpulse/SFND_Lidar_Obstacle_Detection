...
void cluseterHelper(int indice, const std::vector<std::vector<float>> points, std::vector<int> & cluster,  std::vector<bool> & processed, KdTree* tree, float distanceTol ){
	...
	for (int id : nearest)
	{
		if(!processed[id]) cluseterHelper(id, points, cluster, processed, tree, distanceTol);
	}
...
std::vector<std::vector<int>> euclideanCluster(const std::vector<std::vector<float>> points, KdTree* tree, float distanceTol)
{
	...
	while (i < points.size())
	{
		...
		cluseterHelper(i, points, cluster, processed, tree, distanceTol);
